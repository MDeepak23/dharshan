              ...
              <div>
                ...
                <div className="stats-grid">
                  ...
                  <div className="stat-card" style={{ borderLeft: '3px solid var(--primary)' }}>
                    <div className="stat-icon" style={{ background: 'rgba(255,109,0,0.15)' }}>
                    ...
                    <div key={t._id} style={{ background: 'var(--highlight-1)', border: '1px solid var(--glass-border)', padding: '1rem', borderRadius: '8px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                        <div>
                          ...
                          <div style={{ fontSize: '0.85rem', background: 'rgba(255,109,0,0.1)', color: 'var(--primary)', padding: '2px 8px', borderRadius: '12px' }}>Location: {t.location}</div>
                        </div>
